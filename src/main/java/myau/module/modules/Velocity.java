        ...
        if (event.getType() == EventType.POST) {
            if (this.reverseFlag
                    ...
                    this.canDelay()
                            ...
                            || OpenMyau.delayManager.getDelay() >= (long) this.delayTicks.getValue()
            )) {
                OpenMyau.delayManager.setDelayState(false, DelayModules.VELOCITY);
                ...
                if (packet.getEntityID() == mc.thePlayer.getEntityId()) {
                    ...
                    if (this.mode.getValue() == 2
                        ...
                        if (this.delayChanceCounter >= 100) {
                            OpenMyau.delayManager.setDelayState(true, DelayModules.VELOCITY);
