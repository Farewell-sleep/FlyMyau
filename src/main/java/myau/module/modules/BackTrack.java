...
public class BackTrack extends Module {
    ...
    private LagRange getLagRange() {
        Module m = OpenMyau.moduleManager.getModule(LagRange.class);
    ...
    public void onPacket(PacketEvent event) {
        ...
        Module scaffold = OpenMyau.moduleManager.getModule(Scaffold.class);
    ...
    private EntityLivingBase resolveTarget() {
        KillAura ka = (KillAura) OpenMyau.moduleManager.modules.get(KillAura.class);
